<template>
  <div
      ...
      :class="[
        'group relative flex cursor-pointer touch-manipulation items-center rounded-xl border border-border bg-card transition-all duration-200 hover:border-primary/30 hover:bg-accent/50 hover:shadow-[0_4px_20px_rgb(0,0,0,0.03)] dark:hover:shadow-none',
  ...
  >
    ...
    <button
        ...
        class="flex size-7 shrink-0 touch-manipulation items-center justify-center rounded-md transition-all hover:bg-background"
