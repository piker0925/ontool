        ...
        <div class="flex flex-col overflow-hidden">
          ...
          <div v-if="heavyConfig?.params.length" class="flex shrink-0 flex-col gap-3 border-b border-border p-4">
            ...
            <div v-if="mod?.id === 'image-resize'" class="flex flex-col gap-2" data-testid="resize-size-block">
              ...
              <select
                  ...
                  class="w-auto min-w-[96px] self-start rounded-md border border-input bg-background px-3 py-1.5 text-[13px] text-foreground outline-none transition-colors focus:ring-2"
          ...
          <div class="flex flex-1 flex-col overflow-auto p-6">
            <FileUploader
                ...
                :maxFiles="heavyConfig?.maxFiles"
                :moduleId="mod.id"
                :multiple="heavyConfig?.fileMultiple ?? true"
                :params="heavyFormValues"
                :reorderable="heavyConfig?.reorderable ?? false"
                :secondSlotAccept="heavyConfig?.secondSlotAccept"
                :secondSlotItemLabel="heavyConfig?.secondSlotItemLabel"
                :secondSlotLabel="heavyConfig?.secondSlotLabel"
