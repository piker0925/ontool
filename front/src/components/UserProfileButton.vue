  ...
  <template v-else>
    <DropdownMenu v-if="isLoggedIn && user">
      <DropdownMenuTrigger as-child>
        <button class="relative flex items-center justify-center h-8 w-8 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 text-primary font-bold shadow-sm ring-1 ring-border/50 transition-[box-shadow] hover:ring-primary/50 hover:shadow-md focus:outline-none">
    ...
    <Dialog v-else>
      <DialogTrigger as-child>
        <button class="flex h-8 shrink-0 items-center justify-center whitespace-nowrap rounded-full bg-primary px-5 text-[13px] font-semibold text-primary-foreground shadow-sm transition-[scale,background-color,box-shadow] hover:scale-105 hover:bg-primary/90 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-primary/20">
          로그인
        </button>
      </DialogTrigger>
      <DialogContent class="sm:max-w-[400px]">
        ...
        <div class="flex flex-col gap-3 px-4 pb-4">
          <div class="flex flex-col gap-1.5">
            <button @click="loginWithGoogle()" class="relative flex h-11 w-full items-center justify-center rounded-xl border border-border bg-background px-4 text-[14px] font-medium transition-[background-color] hover:bg-accent focus:outline-none focus:ring-2 focus:ring-primary/20">
          ...
          <div class="flex flex-col gap-1.5">
            <button @click="loginWithKakao()" class="relative flex h-11 w-full items-center justify-center rounded-xl bg-[#FEE500] px-4 text-[14px] font-medium text-black transition-[background-color] hover:bg-[#FEE500]/90 focus:outline-none focus:ring-2 focus:ring-[#FEE500]/50">
