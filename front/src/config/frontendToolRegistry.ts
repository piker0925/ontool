...
export const FRONTEND_TOOL_COMPONENTS: Record<string, FrontendToolEntry> = {
    ...
    'annual-leave-calculator': {load: () => import('../components/tools/AnnualLeaveCalculatorTool.vue'), layout: 'narrow'},
    'weekly-holiday-pay-calculator': {load: () => import('../components/tools/WeeklyHolidayPayCalculatorTool.vue'), layout: 'narrow'},
    'unemployment-benefit-calculator': {load: () => import('../components/tools/UnemploymentBenefitCalculatorTool.vue'), layout: 'narrow'},
    'compound-interest-calculator': {load: () => import('../components/tools/CompoundInterestCalculatorTool.vue'), layout: 'narrow'},
    'installment-calculator': {load: () => import('../components/tools/InstallmentCalculatorTool.vue'), layout: 'narrow'},
    'savings-goal-calculator': {load: () => import('../components/tools/SavingsGoalCalculatorTool.vue'), layout: 'narrow'},
    'subscription-score-calculator': {load: () => import('../components/tools/SubscriptionScoreCalculatorTool.vue'), layout: 'narrow'},
    'ltv-dti-dsr-calculator': {load: () => import('../components/tools/LtvDtiDsrCalculatorTool.vue'), layout: 'narrow'},
    'bac-calculator': {load: () => import('../components/tools/BacCalculatorTool.vue'), layout: 'narrow'},
    'discharge-date-calculator': {load: () => import('../components/tools/DischargeDateCalculatorTool.vue'), layout: 'narrow'},
    'fuel-cost-calculator': {load: () => import('../components/tools/FuelCostCalculatorTool.vue'), layout: 'narrow'},
    'income-tax-calculator': {load: () => import('../components/tools/IncomeTaxCalculatorTool.vue'), layout: 'narrow'},
    'biorhythm-calculator': {load: () => import('../components/tools/BiorhythmCalculatorTool.vue'), layout: 'narrow'},
    'blood-type-name-compatibility': {load: () => import('../components/tools/BloodTypeNameCompatibilityTool.vue'), layout: 'narrow'},
    ...
    'icebreaker-question': {load: () => import('../components/tools/IcebreakerQuestionTool.vue'), layout: 'narrow'},
