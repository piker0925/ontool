<template>
  <div class="flex flex-col gap-4 max-w-lg mx-auto w-full">
    <p class="text-[11px] text-muted-foreground">시급제·주급제 근로자가 주 40시간을 초과해 일했을 때 가산수당을 계산합니다. 월급제라면 "시급↔월급↔연봉 변환기"에서 환산시급을 먼저 구해 아래에 입력하세요.</p>
    ...
    <p class="text-[11px] text-muted-foreground">근로기준법 §56 연장근로 가산(통상임금의 50% 이상)</p>
