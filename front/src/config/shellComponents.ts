...
export const FULL_SHELL_COMPONENTS: Record<string, () => Promise<Component>> = {
    ...
    'game-idle-clicker': () => import('../components/games/IdleClickerGame.vue').then(m => m.default),
    ...
    'game-breakout': () => import('../components/games/BreakoutGame.vue').then(m => m.default),
    'game-obstacle-dodge': () => import('../components/games/ObstacleDodgeGame.vue').then(m => m.default),
