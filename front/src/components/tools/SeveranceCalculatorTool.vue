<template>
  <div class="flex flex-col gap-4 max-w-lg mx-auto w-full">
    ...
    <p class="text-[11px] text-muted-foreground">최근 3개월 급여명세서의 세전 총액(기본급+제수당)을 더한 값이에요. 재직일수와 3개월 산정기간 일수는 입사일·퇴사일로 자동 계산됩니다.</p>
    ...
    <p class="text-[11px] text-muted-foreground">근로기준법 §2 평균임금 · 근로자퇴직급여 보장법 §8 기준(30일분 × 근속연수). 통상임금과의 최저한도 비교는 포함하지 않은 단순 모델이라 실제 수령액과 다를 수 있습니다 — 정확한 금액은 회사 인사팀 또는 고용노동부에 확인하세요.</p>
