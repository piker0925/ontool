<template>
  <BattleLobbyShell
      ...
      @start="onStart"
  >
    <OmokBoard :code="code ?? undefined" :dino-progress-map="lobby.dinoProgressMap.value" :is-multi="true" :participant-id="lobby.participantId.value || undefined" :participants="lobby.participants.value" :room-session-token="lobby.roomSessionToken.value || undefined"/>
  </BattleLobbyShell>
</template>
...
import OmokBoard from './OmokBoard.vue'
