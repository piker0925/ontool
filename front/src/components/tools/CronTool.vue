<template>
  <div class="flex flex-col gap-4 max-w-lg mx-auto w-full">
    <div class="flex flex-col gap-1.5">
      <label class="text-[12px] font-medium text-muted-foreground">Cron 표현식 (분 시 일 월 요일)</label>
    ...
    <div class="flex items-center gap-3">
      <label class="text-[12px] font-medium text-muted-foreground shrink-0">타임존</label>
      <input v-model="tz"
             ...
             spellcheck="false"
             type="text"/>
      <label class="text-[12px] font-medium text-muted-foreground shrink-0">개수</label>
