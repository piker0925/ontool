...
import {AlignLeft, Calculator, FileText, Globe, Image, Music, ShieldCheck, Terminal, Type, Wrench, Zap,} from 'lucide-vue-next'
...
export const CATEGORY_CONFIG: Record<string, CategoryConfig> = {
    ...
    '오디오': {icon: Music as Component, bg: 'bg-cyan-50', color: 'text-cyan-600', thumbBg: 'bg-cyan-600'},
}

export const CATEGORY_ORDER = [
    'PDF', '이미지', '생성기', '보안·암호화', '포맷터', '텍스트', '네트워크', 'DevOps', '생활', '오디오',
]
