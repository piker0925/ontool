...
export const FRONTEND_TOOL_COMPONENTS: Record<string, FrontendToolEntry> = {
    ...
    'random-team-split': {load: () => import('../components/tools/RandomTeamTool.vue'), layout: 'narrow'},
    'ladder-game': {load: () => import('../components/tools/LadderGameTool.vue'), layout: 'narrow'},
